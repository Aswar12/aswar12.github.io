...
<body>
  ...
  <header id="header">
    ...
    <div class="container">
      ...
      <div class="social-links">
        <a href="https://twitter.com/SumarlinAswar?s=08" class="twitter"><i class="bi bi-twitter"></i></a>
        <a href="https://web.facebook.com/aswar.sumarlin/" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="https://www.instagram.com/aswar_sumarlin/" class="instagram"><i class="bi bi-instagram"></i></a>
        <a href="https://www.linkedin.com/in/aswar-sumarlin-8800b6172/" class="linkedin"><i class="bi bi-linkedin"></i></a>
      </div>
    </div>
    </div>
  </header><!-- End Header -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Tanggal lahir :</strong> <span>12 january 2001</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Website :</strong> <span>www.example.com</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>No telepon/wa:</strong> <span>087 886 576 650</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Alamat:</strong> <span>Bone, Segeri, Kab.Pangkep</span></li>
              </ul>
            </div>
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Umur :</strong> <span>20 tahun</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Jurusan:</strong> <span>Technical Information</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>aswarthedoctor@gmail.com</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Status:</strong> <span>Jomblo</span></li>
              </ul>
            </div>
          </div>
          <p>
    ...
    <div class="skills container">
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill"> Public speaking <i class="val">20%</i></span>
          ...
          <div class="progress">
            <span class="skill"> Otomotif/Perbengkelan <i class="val">30%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill"> Dunia IT <i class="val">20%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill"> Olahraga <i class="val">23%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill"> financial/business <i class="val">19%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="19" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
    ...
    <div class="interests container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
          <div class="icon-box">
            <i class="ri-book-3-line" style="color: #11dbcf;"></i>
            <h3>Buku</h3>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <img src="assets/img/futsal.png" alt="">
            <h3> Olahraga</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              ...
              <img src="assets/img/testimonials/Seneque.jpg" class="testimonial-img" alt="">
              <h3>Seneca</h3>
              <h4>Filsuf</h4>
            </div>
  ...
  <section id="contact" class="contact">
    <div class="container">
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6 d-flex align-items-stretch">
          <div class="info-box">
            <i class="bx bx-map"></i>
            <h3>Alamat </h3>
            <p>Bone, Segeri, Kabupaten Pangkajene Dan Kepulauan, Sulawesi Selatan 90655</p>
          </div>
        </div>
      ...
      <form name='submit-to-google-sheet' method="post" role="form" class="php-email-form mt-4">
        <div class="row">
  ...
  <div class="credits">
    ...
    Designed by <a href="https://www.instagram.com/aswar_sumarlin">Aswar Sumarlin</a>
  </div>
